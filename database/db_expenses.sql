...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Apr 15, 2024 at 04:25 AM
...
(15, 'Aroma', 'K', 'P', 9059651304, 'kp@gmail.com'),
(17, 'Green beanery', 'J', 'P', 9059651304, 'jp@gmail.com'),
(18, '5030810', 'U', 'P', 9059651304, 'up@gmail.com'),
(19, 'openxcell', 'D', 'P', 9059651304, 'dp@gmail.com');
...
CREATE TABLE IF NOT EXISTS `tbl_invoices` (
  ...
  `inv_desc` varchar(1000) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `inv_tax` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
...
(1, 15, '2024-04-14', 'service', 'service-1', 'HST', 'pending', 1000),
(2, 15, '2024-04-13', 'full service', 'service-2', 'HST', 'pending', 3000),
(3, 15, '2024-04-08', 'partial service', 'service-3', 'HST', 'paid', 2500),
(4, 17, '2024-04-11', 'repiar', 'repair-espresso-machine', 'HST', 'paid', 1200);
...
INSERT INTO `tbl_register` (`user_id`, `firstname`, `lastname`, `email`, `password`, `date_of_birth`) VALUES
(1, 'keyur', 'panchal', 'panchalkeyur@gmail.com', 'keyur1234', '2024-03-21'),
...
ALTER TABLE `tbl_profile`
  ADD CONSTRAINT `tbl_profile_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `tbl_register` (`user_id`);

--
-- Constraints for table `tbl_salary`
--
ALTER TABLE `tbl_salary`
  ADD CONSTRAINT `tbl_salary_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `tbl_register` (`user_id`);
COMMIT;
